		...
		<div class="content_holder">
			...
			<div class="form_block form_block_wide" id="formBlock">
				<div class="cluster">
					...
					<thead>
						<tr>
						    <th colspan="7"><spring:message code="result.label.logInactivation" />&nbsp;<fmt:formatNumber type="number" maxFractionDigits="0" groupingUsed="false" value="${logReduction }" /></th>
						</tr>
					</thead>
					</table>
					...
					<thead>
						<tr>
						    <th colspan="2" />
						    <th colspan="5" style="text-align: center">pH<br>k/Cr(mg/l)</th>
						</tr>
						<tr>
						    <th style="text-align: center">Temp</th>
						    <th style="text-align: center">K-Value</th>
							<c:forEach items="${phList}" var="ph">
							<th style="text-align: center">
								<fmt:formatNumber type="number" maxFractionDigits="1" groupingUsed="false" value="${ph }" />
							</th>
							</c:forEach>						    
						</tr>
						<tr>
						    <th style="text-align: center">oC</th>
							<th style="text-align: center">k/Cr (mg/l)</th>
							<c:forEach items="${phList}" var="ph">
							<th style="text-align: center">
								<fmt:formatNumber type="number" maxFractionDigits="1" groupingUsed="false" value="${dose }" />
							</th>
							</c:forEach>						    
						</tr>
					</thead>
					<tbody>
						...
						<tr>
						    ...
						    <td style="text-align: center">
						    	<fmt:formatNumber type="number" maxFractionDigits="2" groupingUsed="false" value="${chlorineDisinfectionModel.getKValue(temperature) }" />
						    </td>
							<c:forEach items="${phList}" var="ph">
							<td style="text-align: center">
						    	<fmt:formatNumber type="number" maxFractionDigits="0" groupingUsed="false"
							    	value="${chlorineDisinfectionModel.getCTValue(logReduction, temperature, dose, ph) }" />
							</td>
							</c:forEach>						    
						</tr>
						</c:forEach>
