	...
	<body>
		...
		<div id="list-artikel" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="artikelCategorie" title="${message(code: 'artikel.artikelCategorie.label', default: 'Artikel Categorie')}" />
				...
				<g:each in="${artikelInstanceList}" status="i" var="artikelInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: artikelInstance, field: "artikelCategorie")}</td>
			...
			<div class="pagination">
				<g:paginate total="${artikelInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
