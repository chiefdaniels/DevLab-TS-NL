...
<div class="fieldcontain ${hasErrors(bean: boekInstance, field: 'pages', 'error')} required">
	<label for="pages">
		<g:message code="boek.pages.label" default="Pages" />
		<span class="required-indicator">*</span>
	</label>
	<g:field name="pages" type="number" value="${boekInstance.pages}" required=""/>
</div>
