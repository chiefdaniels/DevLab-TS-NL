	...
	<body>
		...
		<div id="show-boek" class="content scaffold-show" role="main">
			...
			<ol class="property-list boek">
				...
				<g:if test="${boekInstance?.pages}">
				<li class="fieldcontain">
					<span id="pages-label" class="property-label"><g:message code="boek.pages.label" default="Pages" /></span>
					
						<span class="property-value" aria-labelledby="pages-label"><g:fieldValue bean="${boekInstance}" field="pages"/></span>
